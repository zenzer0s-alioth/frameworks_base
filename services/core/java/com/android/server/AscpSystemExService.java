...
import com.android.internal.util.custom.FullscreenTaskStackChangeListener;
...
public class AscpSystemExService extends SystemService {

    private static final String TAG = "AscpSystemExService";
    ...
    public AscpSystemExService(Context context) {
        super(context);
    ...
    private final class PackageRemovedListener extends LauncherApps.Callback {
        ...
        public void onPackageRemoved(String packageName, UserHandle user) {
            ...
            AscpSystemExService.this.onPackageRemoved(packageName);
        }
